...
if(function_exists("register_options_page")) {
	...
	register_options_page('Header Settings');
	register_options_page('I want to attend');
	register_options_page('I want to host');
	register_options_page('About');
	register_options_page('FAQ');
	register_options_page('Contact');
	register_options_page('Parallax Images');
}
